...
export const IconImagePlaceholder: React.FC<IconProps> = ({ className }) => (
     <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
export const IconSetReference: React.FC<IconProps> = ({ className }) => (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
...
export const IconPalette: React.FC<IconProps> = ({ className }) => (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c.926 0 1.648-.746 1.648-1.667 0-.424-.163-.82-.437-1.125-.29-.289-.438-.652-.438-1.115 0-.926.746-1.648 1.667-1.648H19c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4v1.172c0 .522-.21 1.02-.586 1.394a2.03 2.03 0 0 1-2.828 0 2.03 2.03 0 0 1 0-2.828c.376-.376.586-.872.586-1.394V5c0-1.657-1.343-3-3-3z"/>
    </svg>
);
...
export const IconChevronsLeftRight: React.FC<IconProps> = ({ className }) => (
...
export const IconBrush: React.FC<IconProps> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="m9.06 11.9 2 2 7.07-7.07a2.828 2.828 0 1 0-4-4L9.06 9.9Z" />
        <path d="m7.07 14.94 2-2" />
        <path d="m3.13 18.87 2-2" />
        <path d="M12 22 7.07 17.07" />
    </svg>
);

export const IconEraser: React.FC<IconProps> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const IconSlidersHorizontal: React.FC<IconProps> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M21 4h-7"/>
        <path d="M10 4H3"/>
        <path d="M21 12h-9"/>
